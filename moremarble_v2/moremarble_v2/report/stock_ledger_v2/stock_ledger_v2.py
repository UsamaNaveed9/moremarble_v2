# Copyright (c) 2013, Usama Naveed and contributors
...
def execute(filters=None):
	...
	for rec in data:
		length = frappe.db.get_value("Item", {"name":rec.item_code}, "length")
		width = frappe.db.get_value("Item", {"name":rec.item_code}, "width")
		area = length * width 
		rec["length"] = length
		rec["width"] = width
		if rec.in_qty:
			rec["slab_in_qty"] = rec.in_qty/area
		if rec.out_qty:
			rec["slab_out_qty"] = rec.out_qty/area
		if rec.qty_after_transaction:
			rec["slab_qty_after_transaction"] = rec.qty_after_transaction/area
...
def get_columns():
	columns = [
		...
		{"label": _("Length"), "fieldname": "length", "fieldtype": "Float", "width": 80},
		{"label": _("Width"), "fieldname": "width", "fieldtype": "Float", "width": 80},
		{"label": _("Stock UOM"), "fieldname": "stock_uom", "fieldtype": "Link", "options": "UOM", "width": 90},
		{"label": _("In Qty"), "fieldname": "in_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("Out Qty"), "fieldname": "out_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("SLAB In Qty"), "fieldname": "slab_in_qty", "fieldtype": "Float", "width": 110, "convertible": "qty"},
		{"label": _("SLAB Out Qty"), "fieldname": "slab_out_qty", "fieldtype": "Float", "width": 110, "convertible": "qty"},
		{"label": _("SLAB Balance Qty"), "fieldname": "slab_qty_after_transaction", "fieldtype": "Float", "width": 120, "convertible": "qty"},
		{"label": _("Area"), "fieldname": "qty_after_transaction", "fieldtype": "Float", "width": 100, "convertible": "qty"},
